...
* poll使用 `struct pollfd` 代表一个fd；select 使用 `struct fd_set`代表所有fd一种事件(读/写/异常)，一个bite位代表一个fd，置1的位，表示该fd该类事件需要监听
...
[linux epoll 一网打尽](https://cloud.tencent.com/developer/article/1541633)

[ET,LT对比](https://zhuanlan.zhihu.com/p/92617116)

[epoll源码解析](https://www.cnblogs.com/diegodu/p/9377535.html)
