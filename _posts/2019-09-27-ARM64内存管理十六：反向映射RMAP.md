...
* 通过[struct anon_vma](#anon_vma), [struct anon_vma_chain](#anon_vma_chain)和[sturct vm_area_struct](#vm_area_struct)建立了联系，通过物理页面反向查找到VMA
...
* malloc触发匿名线性区缺页异常, 分配新页面过程中同时建立该页面的反向映射
